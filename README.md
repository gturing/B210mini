...
It enumerates as a USRP B210 under UHD and works with the existing B210 software stack (GNU Radio, MATLAB, srsRAN, OpenAirInterface, SDR++, SDRangel, and others).
...
Dual-channel full-duplex performance kept





Wideband direct-conversion RFIC



USRP B210 (AD9361 class)
...
Small board, field-friendly USB power
...
Pocket / OEM / UAV-payload size





Fewer RF stages, shorter traces
...
Simplified RF front-end, lower parts count
...
2R2T, full duplex, coherent 2×2 MIMO
...
Up to 56 MHz (1×1); ~30.72 MHz per channel in 2×2
...
>10 dBm typical mid-band (lower near 6 GHz)
...
Independent TX / RX LO; MIMO channels share LO per direction
...
Onboard VCTCXO, ±0.5 ppm typical
...
10 MHz ref + 1 PPS (IPEX / U.FL class connectors on many revs)
...
~90 × 63 mm class (B205-like, far smaller than B210)
...
USB 3.0 bus power; ~2.8 W max typical





Original B210 size (for comparison)
...
Original B205mini size (for comparison)
...
Primary driver. Board appears as B210.
...
Communications Toolbox Support Package for USRP





srsRAN / OpenAirInterface
...
Via SoapyUHD or native UHD





Pothos, Inspectrum, custom C++/Python



libuhd

FPGA rebuilds (only if you change HDL) have been demonstrated on Vivado ML Standard 2024.1 targeting Artix-7 XC7A100T. See lmesserStep/LibreSDRB210 for the clone-oriented image notes, including DAC7311 SPI bring-up.
...
uhd_usrp_probe never finishes loading FPGA



Wrong bitstream (Spartan-6 image on Artix-7)



Install the XC7A100T usrp_b210_fpga.bin
...
udev / cable / USB 2.0-only hub



Use a USB 3.0 port; check lsusb
...
USB controller or CPU



Lower sample rate; USB 3.0 host; more recv frames
...
Antenna, gain, or simplified front-end limits



Check SMA/IPEX jumpers; sweep gain; add LNA/PA if needed





MIMO channels not coherent



Different rates or two LOs requested



Same master_clock_rate and center frequency on both channels





Board resets under 2×2 + high rate
...
Powered USB 3.0 hub or external 5 V if the revision provides it
...
XC7A100T B210-clone FPGA image notes: https://github.com/gturing/B210mini
